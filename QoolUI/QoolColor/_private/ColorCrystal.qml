...
//   - containmentMask 用 Crystal4ContainmentMask，centerPoint 默认 (0,0)，
//     与"菱形中心在掩码原点"天然重合（Crystal4ContainmentMask 的文档亦
...
// 水晶4菱形色块：以 `size` 为外接框的菱形，中心在组件原点。
//
...
// - containmentMask 的默认 centerPoint (0,0) 是刻意依赖，
//   菱形命中域 = 掩码外接框的内接菱形。
Shape {
    id: root
